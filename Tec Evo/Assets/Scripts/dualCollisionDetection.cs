...
public class dualCollisionDetection : MonoBehaviour {

    public GameObject GameOBJMoved;
    public GameObject Unlocks;
    public GameObject Unlocks2;
    ...
    void Update()
    {
        ...
        {
            if (Unlocks.activeSelf == false && Unlocks2.activeSelf == false)
            {
                Instantiate(Achevement);
            }
            Debug.Log("clicked when over ");
            Unlocks.SetActive(true);
            Unlocks2.SetActive(true);
        }
    }
}
